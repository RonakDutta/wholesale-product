...
const HeroCarousel = () => {
	...
	return (
		<div className="w-full rounded-2xl mb-2 relative overflow-hidden shadow-xl h-[450px] sm:h-[500px] bg-espresso">
			{slides.map((slide, index) => {
				...
				return (
					...
					>
						...
						{/* Overlay */}
						<div className="absolute inset-0 bg-gradient-to-t from-espresso via-espresso/80 to-espresso/20"></div>
