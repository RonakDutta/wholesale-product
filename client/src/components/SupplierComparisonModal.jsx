...
const BestPill = ({ type }) => (
  <span
    className={`inline-flex items-center ml-1.5 px-1.5 py-px rounded text-[7px] font-extrabold uppercase tracking-widest ring-1 ring-inset whitespace-nowrap leading-none ${BEST_PILL[type]}`}
  >
    Best
  </span>
);
              ...
              >
                ...
                <div
                  className={`mt-4 rounded-xl border p-3.5 transition-colors ${
                    priceIsBest
                      ? "border-clay/20 bg-linear-to-br from-clay/5 to-clay/2 ring-1 ring-inset ring-clay/10"
        ...
        <div className="overflow-hidden rounded-2xl border border-slate-200/80 bg-white shadow-sm">
          <table className="w-full text-left text-sm table-fixed">
            ...
            <thead className="border-b border-slate-100">
              <tr>
                <th className="w-45 p-5 align-bottom text-[9px] font-bold uppercase tracking-[0.15em] text-slate-400 font-mono">
                  Feature
                </th>
            ...
            <tbody className="divide-y divide-slate-100/80">
              <tr className="bg-slate-50/40">
                <td className="w-45 p-4 text-[12px] font-bold uppercase tracking-wider text-slate-600">
                  Unit Price
                </td>
                {suppliers.map((supplier, idx) => {
              ...
              {STAT_FIELDS.map((field, rowIdx) => (
                ...
                >
                  <td className="w-45 p-4 text-[12px] font-medium text-slate-500">
                    {field.label}
                  </td>
            ...
            <tfoot className="bg-slate-50/60 border-t border-slate-100">
              <tr>
                <td className="w-45 p-4 text-[12px] font-medium text-slate-400">
                  Action
                </td>
                {suppliers.map((supplier, idx) => (
                  <td
