...
import { Box, Star, ShieldCheck } from "lucide-react";
	...
	return (
		<main className="min-h-screen flex">
			...
			>
				...
				<div
					ref={glowBlob1Ref}
					className="glow-blob w-[300px] h-[300px] bg-clay/15 -top-20 -left-20"
				/>
				<div
					ref={glowBlob2Ref}
					className="glow-blob w-[250px] h-[250px] bg-sage/10 bottom-20 right-10"
				/>
				...
				>
					<div className="inline-flex items-center gap-2 bg-clay/15 border border-clay/20 text-clay text-xs font-bold uppercase tracking-[0.15em] px-4 py-1.5 rounded-full mb-6">
