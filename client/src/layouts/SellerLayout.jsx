...
/**
 * Shell for the wholesaler workspace.
 *
 * Deliberately does not reuse the marketplace chrome: a dark rail, denser
 * spacing and a cooler palette so the seller area reads as its own product
 * rather than a logged-in corner of the storefront.
 */
const NAV = [
