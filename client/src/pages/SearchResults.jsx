...
const SearchResults = () => {
    ...
    const fetchLiveCatalog = async () => {
      try {
        ...
        dbProducts.forEach((product) => {
          ...
          // Search the catalogue's single wholesaler listing for each product.
          mappedProducts.push({
            ...
            rating: Number(bestSupplier.rating || 0),
  ...
  }, [query, filters, sortBy, fullData, initialFetchDone]);
